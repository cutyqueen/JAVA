...
//		score = new int[5];
		...
		// => 배열명이 score 이므로 score[인데스] 형식으로 접근
...
//		System.out.println(score[5]); // 실행 시 오류 발생!
		...
		// Index 5 out of bounds for length 5 at array.Ex.main(Ex.java:91)
		// => ArrayIndexOutOfBoundsException : Index 5 : 5번 인덱스가 범위를 벗어남
		// => array.Ex.main(Ex.java:91) : Ex.java 클래스의 91번 라인이 오류
...
//			System.out.println(score[i]); // score[0] ~ socre[4] 까지 대응
