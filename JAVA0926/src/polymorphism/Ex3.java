...
public class Ex3 {
	...
	public static void main(String[] args) {
		...
		// => emp.salaryCalcuationAll(new Employee("홍길동", 3000));
...
//	public Employee() {}
	...
	//    따라서, 메서드 파라미터로 다형성을 적용한 Empolyee 타입 필요
...
//			salaryResult = salary;
//		}
		// => Empolyee, Manager, Engineer 모두 Employee 타입으로 볼 수 있기 때문에
		//    (상속으로 인한 is-a 관계이므로!)
		// => 모두 true 가 되어 아래의 else if 조건으로 내려가지 않고 if 블록이 실행됨.
...
//			Manager man = emp; // 자동형변환 불가! 강제형변환 필수!
			...
			System.out.println("Employee -> Engineer 로 다운 캐스팅!");
